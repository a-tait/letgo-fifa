...
router.post('/', async (req, res, next) => {
  ...
  try {
    ...
    const systemPrompt = `You are Cuppy ⚽, the AI assistant for DAI DAI — the FIFA World Cup 2026 live tracker and match simulator. You're enthusiastic, knowledgeable about football, and concise.
